...
double UpperBound(double sigma, double b_)
{
  static double pi = 4.0 * atan(1.0);
  static double fac = 2.0/pi;
  double bound = sigma * fac * exp(.25 * pi * pi * b_ * b_ );
...
int main()
{
  ...
  double bound   = UpperBound(1.0,b_in);
