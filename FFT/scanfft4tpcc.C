...
int main()
{
  ...
  ofstream out("TP-CC-DATEN-FFT-REAL.out");
  ofstream ugout("TP-CC-DATEN-FFT-IMA.out");
  ofstream rfout("CC-FFT2REG.out");

  String data = "TP-DATEN-CC-beta";
