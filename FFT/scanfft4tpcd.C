...
int main()
{
  ...
  cout << "Parameter ln(tau0)  = " << log(tau0)  << endl;
  ...
  for(int l=0; l<=BN; l++)
    {
      ...
      /*
      String pregout = "TP-REGPTAU-CD-beta";
      pregout = pregout + strdup(fix3(beta)) + "-xb" + xb +"-N" + n  + "-p" + p + "-b" +  strdup(sci3(b)) + ".out"; 
