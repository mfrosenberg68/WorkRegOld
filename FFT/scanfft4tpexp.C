...
int main()
{
  ...
  /* Dateien Anfang */
  /*
  ofstream out("TP-EXP-DATEN-FFT-REAL.out");
  ofstream ugout("TP-EXP-DATEN-FFT-IMA.out");
  ofstream rfout("EXP-FFT2REG.out");
  */
  String data = "TP-DATEN-EXP-beta1";
  ...
  lscan = lscan + BN + "-b1" +strdup(sci3(b1)) + "-b2" + strdup(sci3(b2)) + "-p" + p + data ; 
  ...
  for(int l = 0; l<= BN; l++)
    {
      ...
      String regout = "TP-REGSOLUTION-EXP-beta1";
      regout = regout +strdup(fix3(beta1))+"-"+strdup(fix3(t1)) + "-beta2" + strdup(fix3(beta2))+"-"+strdup(fix3(t2)) + "-a" + strdup(fix3(a)) + "-xb" + xb +"-N" + n  + "-p" + p + "-b" +  strdup(sci3(b)) + ".out"; 
      ofstream rout(regout());
      
      String pregout = "TP-REGPTAU-EXP-beta1";
      pregout = pregout +strdup(fix3(beta1))+"-"+strdup(fix3(t1)) + "-beta2" + strdup(fix3(beta2))+"-"+strdup(fix3(t2)) + "-a" + strdup(fix3(a)) + "-xb" + xb +"-N" + n  + "-p" + p + "-b" +  strdup(sci3(b)) + ".out";  
      ofstream pout(pregout());
   
      String l2 = "TP-L2-ERROR-EXP-beta1";
      l2 = l2 + strdup(fix3(beta1))+"-"+strdup(fix3(t1)) + "-beta2" + strdup(fix3(beta2)) +"-"+strdup(fix3(t2)) + "-a" + strdup(fix3(a)) + "-xb" + xb +"-N" + n + "-p" + p + "-b" +  strdup(sci3(b)) + ".out";
      ofstream lout(l2());
