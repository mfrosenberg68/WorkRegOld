...
double GaussReg(double x, double *a, double *t, int N, double b)
{
    double Norm = 0.0;
    double y    = 0.0;
    for(int I = 0; I<=N; I++)
  ...
  for(int l = 0; l<= BN; l++)
    {
      ...
      String regout = "REGSOLUTION-DELTA-xb";
